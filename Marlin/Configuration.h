...
#define STRING_CONFIG_H_AUTHOR "(@blazewicz, E3V2 @ SKR Mini E3 V2.0)" // Who made the changes.
...
// Confirm settings to suppress warnings.
...
#define CUSTOM_MACHINE_NAME "E3V2 @ SKR Mini E3 V2.0"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 12.33f }          // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1803f }       // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0640f }          // (W/K) Heat transfer coefficients from heat block to room air with fan off.
...
#define PIDTEMPBED
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 135.76
  #define DEFAULT_bedKi  26.56
  #define DEFAULT_bedKd 462.57
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 250, 15000 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 7000, 7000, 500, 20000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -8, -1.66 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 240  // Beyond the bed but still reachable. Extends probe range.
